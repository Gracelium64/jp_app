...
abstract class Palette {
  static final Color transparent = const Color.fromARGB(0, 0, 0, 0);
  static final Color menuCardGradientPurple =
      const Color.fromARGB(255, 129, 81, 231);
  static final Color menuCardGradientPurpleGrey =
      const Color.fromARGB(155, 133, 129, 244);
  static final Color menuCardGradientGrey =
      const Color.fromARGB(18, 255, 255, 255);
  static final Color menuCardBorder = const Color.fromARGB(255, 151, 151, 158);
  static final Color textWhite = const Color.fromARGB(255, 255, 255, 255);
  ...
  static final Color buttonGradientOrange =
      const Color.fromARGB(255, 246, 158, 163);
  static final Color buttonGradientPink =
      const Color.fromARGB(255, 233, 122, 196);
  static final Color starColor = const Color.fromARGB(255, 235, 120, 172);
  static final Color buttonOutlineDark =
      const Color.fromARGB(255, 200, 52, 146);
